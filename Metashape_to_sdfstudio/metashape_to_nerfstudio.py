...
def parse_args():
    parser = argparse.ArgumentParser(
        description="preprocess metashape camera pose(.xml) to nerfstudio camera pose(.json)")
...
if __name__ == "__main__":
    ...
    main(args)
# e.g. python metashape_to_nerfstudio.py --xml T:\ProjectData\MetaShape_Project\cameras4sdfstudio_lab04.xml --img-folder D:\Project\CmakeProject\instant-ngp\data\nerf\UAV_01\images\ --img-type JPG
