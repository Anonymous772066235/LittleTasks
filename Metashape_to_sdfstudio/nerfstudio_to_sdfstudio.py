...
import world_to_lookdown as pt
...
def main(args):
    ...
    elif args.scene_type in ["lookdown"]:
        ic(np.array(args.center_target))
        poses, scale_mat = pt.lookdown_cube(poses, np.array(args.center_target))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scene-type", dest="scene_type", required=True,
                        choices=["indoor", "object", "unbound", "lookdown"],
    ...
    main(args)
    # e.g. python nerfstudio_to_sdfstudio.py --data D:\Project\CmakeProject\instant-ngp\data\nerf\UAV_01 --output-dir ./ --data-type colmap --scene-type lookdown
